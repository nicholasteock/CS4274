...
public class PSGConfiguration {
	...
	public static String defaultIP = "192.168.0.12"; // IP address of the PSG; getIPAddress();//
    ...
    public static final String QP_REFERENCE = "http://192.168.0.12:10004/xmlrpc"; // psg IP
