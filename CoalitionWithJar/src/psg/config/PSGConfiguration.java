...
public class PSGConfiguration {
	...
	public static String defaultIP = "192.168.10.55"; // IP address of the PSG; getIPAddress();//
    ...
    public static final String QP_REFERENCE = "http://192.168.10.55:10004/xmlrpc"; // psg IP
